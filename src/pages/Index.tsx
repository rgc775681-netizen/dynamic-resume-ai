    ...
    <div className="min-h-screen relative overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-up space-y-6">
            ...
            <p className="text-lg text-muted-foreground max-w-xl">
              Dynamic recruitment + intelligent resume parsing. Upload a resume and our system extracts skills, experience, and education — then matches candidates to jobs in seconds.
            </p>
            ...
            <div className="flex flex-wrap gap-6 pt-4 text-sm text-muted-foreground">
              {["Smart parsing", "Skill matching", "Realtime database"].map(t => (
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="text-center mb-14 animate-fade-up">
          ...
          <p className="text-muted-foreground text-lg">A modern database-backed recruitment system with smart matching.</p>
        </div>
        <div className="grid md:grid-cols-3 gap-6">
          {[
            { icon: Brain, title: "Smart Resume Parsing", desc: "Upload any resume — our system extracts name, skills, experience, education and a professional summary instantly.", color: "from-primary to-accent" },
            ...
            { icon: Users, title: "Dual Dashboards", desc: "Beautiful, role-specific workspaces for recruiters and candidates. Row-level security keeps data safe.", color: "from-accent to-primary" },
      ...
      <footer className="container mx-auto px-4 py-8 text-center text-sm text-muted-foreground space-y-1">
        <p>Built by Raghavendra G C</p>
